...
## `zmap_{Var}_{Date}.txt`
 ...
 - **Requirements**:
	 - Field separator: semicolon `;`;
	 - Decimal separator: period `.`;
 - **File sample**: [zmap_{Var}_{Date}.txt](https://github.com/ipo-exe/tklab/blob/main/samples/zmap_{Var}_{Date}.txt);
 - **Formating example**:

## `zmap_{Var}_{Stat}.txt`
 ...
 - **Requirements**:
	 - Field separator: semicolon `;`;
	 - Decimal separator: period `.`;
 - **File sample**: [zmap_{Var}_{Stat}.txt](https://github.com/ipo-exe/tklab/blob/main/samples/zmap_{Var}_{Stat}.txt);
 - **Formating example**:

## `zmap_{Var}_{Stat}_annual.txt`
 ...
 - **Requirements**:
	 - Field separator: semicolon `;`;
	 - Decimal separator: period `.`;
 - **File sample**: [zmap_{Var}_{Stat}_annual.txt](https://github.com/ipo-exe/tklab/blob/main/samples/zmap_{Var}_{Stat}_annual.txt);
 - **Formating example**:
...
## `map_{Var}_{Date}.asc`
 ...
 - **Requirements**:
	 ...
	 - CRS must be projected (coordinates in meters);
	 - Grid cells must be squared;
 - **File sample**: [map_{Var}_{Date}.asc](https://github.com/ipo-exe/tklab/blob/main/samples/map_{Var}_{Date}.asc);
 - **Formating example**:
...
## `map_{Var}_{Stat}.asc`
 ...
 - **Requirements**:
	 ...
	 - CRS must be projected (coordinates in meters);
	 - Grid cells must be squared;
 - **File sample**: [map_{Var}_{Stat}.asc](https://github.com/ipo-exe/tklab/blob/main/samples/map_{Var}_{Stat}.asc);
 - **Formating example**:

## `map_{Var}_annual_{Stat}.asc`
 ...
 - **Requirements**:
	 ...
	 - CRS must be projected (coordinates in meters);
	 - Grid cells must be squared;
 - **File sample**: [map_{Var}_annual_{Stat}.asc](https://github.com/ipo-exe/tklab/blob/main/samples/map_{Var}_annual_{Stat}.asc);
 - **Formating example**:
